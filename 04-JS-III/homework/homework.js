...
function agregarNumeros(numeros) {
  ...
  // Tu código:
  return numeros.reduce((current, acc) => acc += current, 0);
}
...
function mesesDelAño(array) {
  ...
  const month_to_find = ["Enero", "Marzo", "Noviembre"]
  const result = array.filter(month => month_to_find.includes(month))
